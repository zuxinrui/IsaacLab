...
_USD_PATH_VU_TCP = "source/isaaclab_assets/data/Robots/Lynx/lynx-vu-tcp-urdf.usd"
...
@configclass
class LynxArmTcpCfg(ArticulationCfg):
    """Configuration for the Lynx arm."""

    spawn: sim_utils.UsdFileCfg = sim_utils.UsdFileCfg(
        usd_path=_USD_PATH_VU_TCP,
        activate_contact_sensors=False,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            max_depenetration_velocity=5.0,
    ...
    # end-effector link name
    end_effector_link_name: str = "tcp"
    # end-effector site name
    end_effector_site_name: str = "end_effector"

LYNX_CFG = LynxArmCfg()
LYNX_CFG_TCP = LynxArmTcpCfg()
