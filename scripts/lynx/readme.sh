...
# push and ball in cup tasks:
python scripts/reinforcement_learning/rsl_rl/train.py --task=Isaac-Push-Cube-Lynx-v0 --num_envs 32 --headless
python scripts/reinforcement_learning/rsl_rl/train.py --task=Isaac-Push-Cube-Lynx-ObsDelay-v0 --num_envs 32 --headless
python scripts/reinforcement_learning/rsl_rl/train.py --task=Isaac-Ball-In-Cup-Lynx-v0 --num_envs 32 --headless
python scripts/reinforcement_learning/rsl_rl/train.py --task=Isaac-Ball-In-Cup-Lynx-v1 --num_envs 32 --headless
...
# ===========================================================================================================================
# customed training:
python scripts/lynx/train.py --task=Isaac-Push-Cube-Lynx-v0 --num_envs 32 --headless
...
python -m torch.distributed.run --nnodes=1 --nproc_per_node=2 scripts/lynx/train.py --task=Isaac-Push-Cube-Lynx-ObsDelay-v0 --distributed --headless --num_envs 16384
python -m torch.distributed.run --nnodes=1 --nproc_per_node=2 scripts/lynx/train.py --task=Isaac-Ball-In-Cup-Lynx-v0 --distributed --headless --num_envs 8192
python -m torch.distributed.run --nnodes=1 --nproc_per_node=2 scripts/lynx/train.py --task=Isaac-Ball-In-Cup-Lynx-v1 --distributed --headless --num_envs 8192


# Interactive debug command (GUI, fewer envs for smooth viewport):
python scripts/reinforcement_learning/rsl_rl/play.py --task=Isaac-Push-Cube-Lynx-Play-v0 --num_envs 16 --load_run /home/zuxinrui/IsaacLab/logs/rsl_rl/lynx_push/2026-03-23_15-10-11 --checkpoint /home/zuxinrui/IsaacLab/logs/rsl_rl/lynx_push/2026-03-23_15-10-11/model_1999.pt
